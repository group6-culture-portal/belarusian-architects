export default {
  en: `A theatre director or stage director is a professional in the theatre field who oversees and orchestrates 
  ...
  ru: `Театральный режиссер или режиссер-постановщик - это профессионал в театральной области, который курирует и 
  ...
  bl: `Тэатральны рэжысёр або рэжысёр-пастаноўшчык - гэта прафесіянал у тэатральнай галіне, які курыруе і
